...
jest.mock('fs-extra', () => ({
  ...
  outputFile: (outputFileName, theContent) => {
    ...
    // ref: https://pubs.opengroup.org/onlinepubs/9699919799.2013edition/basedefs/errno.h.html
    return Promise.reject(new Error(`ENOSPC no space left`));
  },
}));
...
test('create alice-bobbi module with logging, with NOSPC error when writing file', async () => {
