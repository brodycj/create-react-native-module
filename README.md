...
Options:
  ...
  --android-build-gradle-extra              [Android] Include extra build steps in build.gradle
...
```javascript
{
  ...
  androidBuildGradleExtra: Boolean, /* [Android] Include extra build steps in build.gradle */
