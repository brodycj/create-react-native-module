...
Options:
  ...
  --module-prefix <modulePrefix>            The prefix of the generated module package name, ignored if --package-name is specified (Default: `react-native`)
...
```javascript
{
  ...
  modulePrefix: String, /* The prefix of the generated module package name, ignored if packageName is specified (Default: `react-native`) */
