...
const DEFAULT_ANDROID_PACKAGE_ID = 'com.reactlibrary';
...
const generateWithNormalizedOptions = ({
  ...
  packageName,
  objectClassName,
  androidPackageId = DEFAULT_ANDROID_PACKAGE_ID,
  ...
  if (androidPackageId === DEFAULT_ANDROID_PACKAGE_ID) {
    warn(`While \`{DEFAULT_ANDROID_PACKAGE_ID}\` is the default package
...
Android androidPackageId: ${androidPackageId}
                platforms: ${platforms}
