...
const generateWithNormalizedOptions = ({
  ...
  addExamplePostinstallScript = false,
}, {
...
` + (generateExample
  ...
  addExamplePostinstallScript: ${addExamplePostinstallScript}
` : ``));
      ...
      return Promise.resolve()
        ...
        .then(() => {
          ...
          return new Promise((resolve, reject) => {
            ...
            if (addExamplePostinstallScript) {
              console.info('Adding example cleanup postinstall script to the example app');
            ...
            try {
              commandSync('yarn add link:../', addLinkLibraryOptions);
            } catch (e) {
